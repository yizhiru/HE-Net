 ...
 */
    template<template<typename...> class Container, typename Image, typename Label = uint8_t>
    CIFAR10_dataset<Container, Image, Label>
    read_dataset_direct(const std::string &folder, std::size_t training_limit = 0, std::size_t test_limit = 0) {
        CIFAR10_dataset<Container, Image, Label> dataset;

        read_training(folder, training_limit, dataset.training_images, dataset.training_labels,
                      [] { return Image(3 * 32 * 32); });
 ...
 */
    ...
    read_dataset(const std::string &folder, std::size_t training_limit = 0, std::size_t test_limit = 0) {
